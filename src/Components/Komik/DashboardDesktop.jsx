...
const DashboardDesktop = () => {
    ...
    return (
        <div className='dashboard full row pb-3'>
            <nav className="d-flex p-3">
                <h3 className="me-auto text-white">Dashboard</h3>
            ...
            <div className="col-8 d-flex align-items-end">
                <h2 className="text-white ms-4 mb-2">Selamat datang,<br />Semoga harimu menyenangkan</h2>
            </div>
            <div className="col-4">
                ...
                <Link className="dashboard-card row bg-white shadow rounded mx-3 mb-2" to='/lihatending'>
                    <picture className="col-4 p-2">
